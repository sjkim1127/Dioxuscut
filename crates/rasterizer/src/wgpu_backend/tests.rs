...
#[test]
    ...
    fn gpu_gif_playback_rate_and_loop_behavior_parity_with_cpu() {
        ...
        let test_cases = [
            ...
            (0.15, 0.5, crate::gif_cache::LoopBehavior::Loop, "0.5x rate should select frame 0 (75ms)"),
            (0.06, 2.0, crate::gif_cache::LoopBehavior::Loop, "2.0x rate should select frame 1 (120ms)"),
            (0.08, 1.5, crate::gif_cache::LoopBehavior::Loop, "1.5x rate should select frame 1 (120ms)"),
            (0.30, 1.0, crate::gif_cache::LoopBehavior::Loop, "Loop past duration wraps to frame 1 (100ms)"),
            (0.30, 1.0, crate::gif_cache::LoopBehavior::Pause, "Pause past duration clamps to last frame"),
            (0.30, 1.0, crate::gif_cache::LoopBehavior::Unmount, "Unmount past duration produces nothing"),
        ];
